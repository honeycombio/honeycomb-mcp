...
describe('list-datasets tool', () => {
  ...
  vi.mock('../cache/index.js', () => {
    ...
    return {
      getCache: vi.fn(() => mockCacheManager),
  ...
  describe('with pagination and filtering', () => {
    ...
    beforeEach(() => {
      ...
      getCache().accessCollection.mockReset();
    });
    ...
    it('should return paginated results when using page and limit parameters', async () => {
      ...
      const { getCache } = require('../cache/index.js');
      getCache().accessCollection.mockReturnValue({
      ...
      expect(getCache().accessCollection).toHaveBeenCalledWith(
        'test-env', 
        'dataset', 
        undefined, 
    ...
    it('should handle direct filtering when cache is not available', async () => {
      ...
      const { getCache } = require('../cache/index.js');
      getCache().accessCollection.mockReturnValue(undefined);
